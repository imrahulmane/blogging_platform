...
import { ResetTokenEntity as ResetToken, ResetTokenEntity} from "./reset-token.entity";
...
export class ResetTokenService{
    ...
    async create(user_id: number, token: string): Promise<void>{
        const expiredAfterMinutes = Number(this.configService.get('RESET_TOKEN_EXPIRY'));
